...
def main():
    ...
    for fold, (train_indices, val_indices) in enumerate(kf.split(all_indices)):
        ...
        # optimizer = torch.optim.Adam(net.parameters(), lr=args.learning_rate, weight_decay=1e-5)  # L2 regularization through weight_decay
        ...
        #     lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=25)
        ...
        plot_confusion_matrix(test_results["TP_gsa"], test_results["FP_gsa"], test_results["TN_gsa"], test_results["FN_gsa"], 
                              title=f"mainkfold_gsa_confusion_matrix_{fold}", filename=f"mainkfold_gsa_confusion_matrix_wo_lrs_{fold}.png")
        ...
        plot_confusion_matrix(test_results["TP_hatnet"], test_results["FP_hatnet"], test_results["TN_hatnet"], test_results["FN_hatnet"], 
                              title=f"mainkfold_hatnet_confusion_matrix_{fold}", filename=f"mainkfold_hatnet_confusion_matrix_wo_lrs_{fold}.png")
        ##-----------------------------------------------------------------
    ...
    plot_confusion_matrix(TP_gsa_avg, FP_gsa_avg, TN_gsa_avg, FN_gsa_avg, 
                          title="GSA Model Averaged Confusion Matrix", filename="mainkfold_gsa_avg_confusion_matrix_wo_lrs.png")
    plot_confusion_matrix(TP_hatnet_avg, FP_hatnet_avg, TN_hatnet_avg, FN_hatnet_avg, 
                          title="HatNet Model Averaged Confusion Matrix", filename="mainkfold_hatnet_avg_confusion_matrix_wo_lrs.png")
    ...
    plot_confusion_matrix(avg_results['TP'], avg_results['FP'], avg_results['TN'], avg_results['FN'], 
                          title="DepDet Confusion Matrix", filename="mainkfold_depdet_confusion_matrix_wo_lrs.png")
    plot_confusion_matrix(avg_results['TP_gsa'], avg_results['FP_gsa'], avg_results['TN_gsa'], avg_results['FN_gsa'],
                          title="GSA Confusion Matrix", filename="mainkfold_gsa_confusion_matrix_wo_lrs.png")
    plot_confusion_matrix(avg_results['TP_hatnet'], avg_results['FP_hatnet'], avg_results['TN_hatnet'], avg_results['FN_hatnet'],
                          title="HatNet Confusion Matrix", filename="mainkfold_hatnet_confusion_matrix_wo_lrs.png")
    ...
    plot_confusion_matrix_mean(avg_results['TP'], avg_results['FP'], avg_results['TN'], avg_results['FN'], 
                          title="Mean DepDet Confusion Matrix", filename="mean_mainkfold_depdet_confusion_matrix_wo_lrs.png")
    plot_confusion_matrix_mean(avg_results['TP_gsa'], avg_results['FP_gsa'], avg_results['TN_gsa'], avg_results['FN_gsa'],
                          title="Mean GSA Confusion Matrix", filename="mean_mainkfold_gsa_confusion_matrix_wo_lrs.png")
    plot_confusion_matrix_mean(avg_results['TP_hatnet'], avg_results['FP_hatnet'], avg_results['TN_hatnet'], avg_results['FN_hatnet'],
                          title="Mean HatNet Confusion Matrix", filename="mean_mainkfold_hatnet_confusion_matrix_wo_lrs.png")
    ##-----------------------------------------------------------------
